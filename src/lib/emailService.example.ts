...
// Copiez ce fichier vers emailService.ts et remplacez les valeurs

import emailjs from '@emailjs/browser';

// Configuration EmailJS - REMPLACEZ CES VALEURS
const EMAILJS_SERVICE_ID = 'service_xxxxxxx'; // Votre Service ID depuis EmailJS
const EMAILJS_TEMPLATE_ID = 'template_xxxxxxx'; // Votre Template ID depuis EmailJS
const EMAILJS_PUBLIC_KEY = 'xxxxxxxxxxxxxxx'; // Votre Public Key depuis EmailJS
