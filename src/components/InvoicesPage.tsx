            ...
            <div className="overflow-y-auto flex-1">
              <form onSubmit={handleSubmit} className="p-3 sm:p-4 lg:p-6 space-y-3 sm:space-y-6 lg:space-y-8">
                ...
                {selectedServices.length > 0 && (
                  <div className="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-lg sm:rounded-xl p-3 sm:p-6 border border-blue-200 dark:border-blue-700">
            ...
            <div className="bg-gradient-to-r from-purple-600 via-purple-600 to-purple-700 dark:from-purple-700 dark:via-purple-700 dark:to-purple-800 px-3 py-3 sm:p-4 md:p-6 text-white relative overflow-hidden flex-shrink-0">
              ...
              <div className="flex items-center justify-between relative z-10">
                <div className="flex items-center space-x-2 sm:space-x-3 flex-1 min-w-0">
                  ...
                  <div className="min-w-0 flex-1">
                    <h3 className="text-base sm:text-lg md:text-xl font-bold truncate">Aperçu de la facture</h3>
                    ...
                    <div className="flex items-center flex-wrap gap-1.5 sm:gap-2 mt-1">
                      ...
                      {((previewInvoice as Invoice).invoice_type === 'summary') && (
                        <span className="px-2 py-0.5 sm:py-1 text-xs font-semibold rounded-full bg-purple-100 text-purple-700">
                          Mode synthèse
                        </span>
                      )}
                ...
                <div className="flex space-x-1 sm:space-x-2 flex-shrink-0 ml-1 sm:ml-2">
                  <button
                    type="button"
                    onClick={() => openInvoicePrintWindow(previewInvoice, clients, services)}
                    className="px-2 sm:px-3 md:px-4 py-1.5 sm:py-2 bg-white/20 hover:bg-white/30 rounded-full transition-all duration-200 flex items-center space-x-1 sm:space-x-2 font-medium hover:scale-105 hover:shadow-lg text-xs sm:text-sm"
                  >
                  ...
                  <button
                    ...
                    className="text-white/80 hover:text-white hover:bg-white/20 rounded-full p-1.5 sm:p-2 transition-all duration-200 hover:scale-110 flex-shrink-0"
                    title="Fermer"
                  >
                    <svg className="w-4 h-4 sm:w-5 sm:h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M6 18L18 6M6 6l12 12" />
                ...
                <div className="bg-gradient-to-br from-gray-50 to-white dark:from-gray-800 dark:to-gray-900 border border-gray-200 dark:border-gray-700 rounded-xl sm:rounded-2xl md:rounded-3xl p-3 sm:p-4 md:p-6 lg:p-10 max-w-4xl xl:max-w-5xl mx-auto shadow-2xl hover:shadow-3xl transition-all duration-300">
                    ...
                    <div className="flex items-center space-x-2 sm:space-x-3 md:space-x-6">
                      {(() => {
                        ...
                        return settings?.logoUrl ? (
                          <div className="w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 bg-gradient-to-r from-blue-600 to-indigo-600 rounded-xl sm:rounded-2xl flex items-center justify-center shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 flex-shrink-0">
                            <img src={settings.logoUrl as string} alt="Logo" className="w-8 h-8 sm:w-10 sm:h-10 object-contain" />
                          </div>
                        ) : null;
                      })()}
                      <div className="min-w-0 flex-1">
                        <h1 className="text-lg sm:text-2xl md:text-3xl lg:text-4xl font-bold text-gray-900 dark:text-white tracking-tight truncate">
                          {(settings?.companyName as string) || 'ProFlow'}
                        </h1>
                        <p className="text-gray-600 dark:text-gray-400 font-medium text-xs sm:text-sm md:text-base lg:text-lg truncate">
                          {(settings?.ownerName as string) || 'Votre flux professionnel simplifié'}
                        </p>
                        <div className="mt-2 sm:mt-3 text-xs sm:text-sm md:text-base text-gray-500 dark:text-gray-400 leading-relaxed">
                          <div>
                            {settings?.address && <div className="truncate">{settings.address as string}</div>}
                            {settings?.email && <div className="truncate">{settings.email as string}</div>}
                            {settings?.phone && <div className="truncate">{settings.phone as string}</div>}
                            {settings?.siret && <div className="truncate">SIRET: {settings.siret as string}</div>}
                          </div>
                        </div>
                      </div>
                    </div>
                    <div className="text-right sm:text-right flex-shrink-0">
                      <div className="bg-gradient-to-r from-blue-600 to-indigo-600 text-white px-3 py-2 sm:px-4 sm:py-3 md:px-8 md:py-4 rounded-lg sm:rounded-xl md:rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 inline-block">
                        <h2 className="text-sm sm:text-lg md:text-2xl font-bold">FACTURE</h2>
                        <p className="text-blue-100 font-semibold text-xs sm:text-sm md:text-base">N° {previewInvoice.invoice_number}</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="mb-4 sm:mb-6 md:mb-8 lg:mb-12">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4 md:gap-6 lg:gap-8">
                      <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg sm:rounded-xl md:rounded-2xl p-3 sm:p-4 md:p-6 lg:p-8 border border-blue-200 dark:border-blue-700 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105">
                        <h3 className="text-sm sm:text-base md:text-lg lg:text-xl font-bold text-blue-900 dark:text-blue-100 mb-3 sm:mb-4 md:mb-6 flex items-center">
                          <div className="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 bg-blue-100 dark:bg-blue-900/30 rounded-lg flex items-center justify-center mr-2 sm:mr-3 flex-shrink-0">
                            <svg className="w-3 h-3 sm:w-3.5 sm:h-3.5 md:w-4 md:h-4 text-blue-600 dark:text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                            </svg>
                          </div>
                          Facturé à
                        </h3>
                        <div className="text-gray-900 dark:text-white space-y-1.5 sm:space-y-2">
                          ...
                          <p className="text-xs sm:text-sm md:text-base text-gray-700 dark:text-gray-300 truncate">{previewInvoice.client?.email || clients.find(c => c.id === previewInvoice.client_id)?.email || ''}</p>
                          <p className="text-xs sm:text-sm md:text-base text-gray-700 dark:text-gray-300 truncate">{previewInvoice.client?.phone || clients.find(c => c.id === previewInvoice.client_id)?.phone || ''}</p>
                          <p className="text-xs sm:text-sm md:text-base text-gray-700 dark:text-gray-300 truncate">{previewInvoice.client?.address || clients.find(c => c.id === previewInvoice.client_id)?.address || ''}</p>
                        </div>
                      </div>
                      <div className="bg-green-50 dark:bg-green-900/20 rounded-lg sm:rounded-xl md:rounded-2xl p-3 sm:p-4 md:p-6 lg:p-8 border border-green-200 dark:border-green-700 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105">
                        <h3 className="text-sm sm:text-base md:text-lg lg:text-xl font-bold text-green-900 dark:text-green-100 mb-3 sm:mb-4 md:mb-6 flex items-center">
                          <div className="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 bg-green-100 dark:bg-green-900/30 rounded-lg flex items-center justify-center mr-2 sm:mr-3 flex-shrink-0">
                            <svg className="w-3 h-3 sm:w-3.5 sm:h-3.5 md:w-4 md:h-4 text-green-600 dark:text-green-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                            </svg>
                          </div>
                          Détails de la facture
                        </h3>
                        <div className="text-gray-900 dark:text-white space-y-2 sm:space-y-3">
                          <div className="flex justify-between items-center">
                            <span className="font-medium text-xs sm:text-sm md:text-base text-gray-700 dark:text-gray-300">Date :</span>
                            <span className="font-semibold text-xs sm:text-sm md:text-base text-gray-900 dark:text-white">{new Date(previewInvoice.date).toLocaleDateString('fr-FR')}</span>
                          </div>
                          <div className="flex justify-between items-center">
                            <span className="font-medium text-xs sm:text-sm md:text-base text-gray-700 dark:text-gray-300">Échéance :</span>
                            <span className="font-semibold text-xs sm:text-sm md:text-base text-gray-900 dark:text-white">{new Date(previewInvoice.due_date).toLocaleDateString('fr-FR')}</span>
                          </div>
                          {previewInvoice.payment_method && (
                            <div className="flex justify-between items-center">
                              <span className="font-medium text-xs sm:text-sm md:text-base text-gray-700 dark:text-gray-300">Mode de paiement :</span>
                              <span className="font-semibold text-xs sm:text-sm md:text-base text-blue-600 dark:text-blue-400 truncate ml-2">{previewInvoice.payment_method}</span>
                            </div>
                          )}
                          <div className="flex justify-between items-center pt-2 border-t border-green-200 dark:border-green-700">
                            <span className="font-medium text-xs sm:text-sm md:text-base text-gray-700 dark:text-gray-300">Statut :</span>
                            <span className={`px-2 py-0.5 sm:px-3 sm:py-1 text-xs sm:text-sm font-semibold rounded-full ${
                              previewInvoice.status === 'paid' 
                  ...
                  {/* Services Table */}
                  <div className="mb-4 sm:mb-6 md:mb-8 lg:mb-12">
                    <h3 className="text-base sm:text-lg md:text-xl lg:text-2xl font-bold text-gray-900 dark:text-white mb-4 sm:mb-6 md:mb-8 flex items-center">
                      <div className="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 bg-purple-100 dark:bg-purple-900/30 rounded-lg flex items-center justify-center mr-2 sm:mr-3 flex-shrink-0">
                  ...
                  <div className="flex justify-end">
                    <div className="w-full sm:w-80 md:w-96">
                      <div className="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-lg sm:rounded-xl md:rounded-2xl p-4 sm:p-6 md:p-8 border border-blue-200 dark:border-blue-700 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105">
                        <h4 className="text-base sm:text-lg md:text-xl font-bold text-gray-900 dark:text-white mb-4 sm:mb-6 flex items-center">
                          <div className="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 bg-blue-100 dark:bg-blue-900/30 rounded-lg flex items-center justify-center mr-2 sm:mr-3 flex-shrink-0">
                            <svg className="w-3 h-3 sm:w-3.5 sm:h-3.5 md:w-4 md:h-4 text-blue-600 dark:text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 7h6m0 10v-3m-3 3h.01M9 17h.01M9 14h.01M12 14h.01M15 11h.01M12 11h.01M9 11h.01M7 21h10a2 2 0 002-2V5a2 2 0 00-2-2H7a2 2 0 00-2 2v14a2 2 0 002 2z" />
                            </svg>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl sm:rounded-2xl shadow-2xl w-full max-w-[96vw] sm:max-w-2xl max-h-[70vh] sm:max-h-[90vh] animate-in zoom-in-95 duration-200 flex flex-col">
            ...
            <div className="bg-gradient-to-r from-purple-600 via-purple-600 to-purple-700 dark:from-purple-700 dark:via-purple-700 dark:to-purple-800 px-3 py-3 sm:p-4 md:p-6 text-white rounded-t-xl sm:rounded-t-2xl relative overflow-hidden flex-shrink-0">
              ...
              <div className="flex items-center justify-between relative z-10">
                <div className="flex items-center space-x-2 sm:space-x-3 flex-1 min-w-0">
                  ...
                  <div className="min-w-0 flex-1">
                    <h3 className="text-base sm:text-lg md:text-xl font-bold truncate">Envoyer la facture</h3>
                    <p className="text-white/80 text-xs sm:text-sm truncate">
                ...
                <button
                  ...
                  className="text-white/80 hover:text-white hover:bg-white/20 rounded-lg p-1.5 sm:p-2 transition-colors flex-shrink-0 ml-1 sm:ml-2"
                  title="Fermer"
                >
                  <svg className="w-4 h-4 sm:w-5 sm:h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M6 18L18 6M6 6l12 12" />
            ...
            <div className="p-3 sm:p-4 md:p-6 flex-1 overflow-y-auto">
              <form onSubmit={(e) => { e.preventDefault(); handleSendEmail(); }} className="space-y-3 sm:space-y-4 md:space-y-6">
                ...
                {/* Invoice Summary */}
                <div className="bg-gradient-to-r from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 rounded-lg sm:rounded-xl p-3 sm:p-4 border border-purple-200 dark:border-purple-700">
                  <h4 className="text-xs sm:text-sm font-semibold text-gray-900 dark:text-white mb-2 sm:mb-3 flex items-center">
                    <div className="w-5 h-5 sm:w-6 sm:h-6 bg-purple-100 dark:bg-purple-900/30 rounded-lg flex items-center justify-center mr-2 flex-shrink-0">
                      <svg className="w-2.5 h-2.5 sm:w-3 sm:h-3 text-purple-600 dark:text-purple-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                      </svg>
                    </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3 md:gap-4 text-xs sm:text-sm">
                    <div>
                      ...
                      <span className="font-bold text-gray-900 dark:text-white ml-1 sm:ml-2">{calculateInvoiceAmount(emailModal).toFixed(2)}€</span>
                    </div>
                    <div>
                      <span className="text-gray-600 dark:text-gray-400">Échéance :</span>
                      <span className="font-bold text-gray-900 dark:text-white ml-1 sm:ml-2">{new Date(emailModal.due_date).toLocaleDateString('fr-FR')}</span>
                    </div>
                  </div>
                </div>
